...
<body>
    ...
    <main class="productos grid">
        <div class="productos__field sombra">
            <h1>Harinas de Trigo</h1>
            <p>Nos especializamos en Harinas de Trigo para el sector panadero tradicional e industrial, por lo que
                ofrecemos toda una gama de productos específicos para cada necesidad, obtenidos de la mezcla y molienda
                exacta de granos de trigos seleccionados, maduros, limpios y sanos. </p>
            <p>Contamos con la más avanzada tecnología de molinería por lo que podemos desarrollar productos de
                acuerdo a las necesidades de nuestros clientes:</p>
            
            <ul class="productos__field-list flex">
                <li>Harinas de Alta Proteina</li>
                <li>Harinas Extrafuertes</li>
                <li>Harinas de Fuerza Media</li>
                <li>Harinas Suaves</li>
                <li>Harinas Integrales</li>
            </ul>
            <br>
            <h2><u>Nuestras Marcas</u></h2>
            <div class="grid subproductos">
                <?php
                    include 'utilerias.php';
                    $cs=conecta();
                    $query="SELECT * FROM productos, tipos WHERE tipo_prod='1' and cve_tipo='1' ORDER BY nom_prod";
        ...
        <aside class="productos__field flex sombra">
            <div>
                <h3>Descarga el PDF de Harinas de Trigo</h2>
                <a href="pdfs/00Catálogo_HPI_HB_ld.pdf" download="HarinasDeTrigo">
                    <p>Descarga</p>
                </a>
            </div>
            <div>
