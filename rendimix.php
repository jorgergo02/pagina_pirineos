...
<body>
    ...
    <main class="productos grid">
        <div class="productos__field sombra">
            <h1>Rendimix</h1>
            <p> Formulado con los mejores ingredientes para procesos industriales y artesanales de amasado. Rendimix por su calidad mejora el comportamiento de la masa
                otorgando un excelente volúmen, mayor rendimiento, mejor tolerancia a la fermentación, mayor vida útil a los productos, mejor greñado, 
                miga blanca y uniforme, así como una corteza crujiente. </p>
            <br>
            ...
            <div class="grid subproductos">
                <?php
                    ...
                    $cs=conecta();
                    $query="SELECT * FROM productos, tipos WHERE tipo_prod='3' and cve_tipo='3' ORDER BY nom_prod";
        ...
        <aside class="productos__field flex sombra">
            <div>
                <h3>Descarga el PDF de Rendimix</h2>
                <a href="pdfs/Catálogo_HPI_RendiMix.pdf" download="Rendimix">
                    <p>Descarga</p>
                </a>
            </div>
            <div>
