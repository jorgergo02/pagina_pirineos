...
<body>
    ...
    <main class="productos grid">
        <div class="productos__field sombra">
            <h1>Derivados de Trigo</h1>
            <p> Harinera Los Pirineos ofrece un amplio portafolio de derivados de trigo con valor agregado para diferentes usos que abarcan desde el grado alimenticio
                para consumo humano, hasta el uso forrajero. Empacados en costales, supersacos y granel. </p>
            <br>
            ...
            <div class="grid subproductos">
                <?php
                    ...
                    $cs=conecta();
                    $query="SELECT * FROM productos, tipos WHERE tipo_prod='6' and cve_tipo='6' ORDER BY nom_prod";
        ...
        <aside class="productos__field flex sombra">
            <div>
                <h3>Descarga el PDF de Derivados de trigo</h2>
                <a href="pdfs/Catálogo_HPI_Derivados_trigo.pdf" download="DerivadosTrigo">
                    <p>Descarga</p>
                </a>
            </div>
            <div>
