...
<body>
    ...
    <nav class="menu flex">
        ...
        <ul class="menu__items flex">
            ...
            <li class="active"><a href="recetario.php"> Recetario </a></li>
    ...
    <?php
        function addRecipe($img, $title) {
            echo "
                <div class = 'recetario__field-receta sombra grid'>
                    <h3 class = 'receta'>$title</h3>
                    <div class = 'receta contenedor-receta'>
                        <img src = ' recetas/$img '>
                    </div>
                    <a class= ' receta' href='recetas/$img' download='$title'>
                        <button type = 'button' 
                            class = 'boton green-button'>
                            Descarga Receta </button>
                    </a>
                </div>
            ";
        }
    ...
    <main class="recetario">
        <h1>Conóce nuestras recetas</h1>
        <br><br>
        <div class="recetario__field flex">
        <?php
            addRecipe("Abanicos_receta.jpg", "Abanicos");
            addRecipe("Alcatraces_receta.jpg", "Alcatraces");
            addRecipe("Baguette_receta.jpg", "Baguette");
            addRecipe("Besos_receta.jpg", "Besos");
        ?>
        </div>
